...
class ItemsTableDealerLess extends StatefulWidget {
  const ItemsTableDealerLess({super.key});

  @override
  State<ItemsTableDealerLess> createState() => _ItemsTableDealerLessState();
}

class _ItemsTableDealerLessState extends State<ItemsTableDealerLess> {
  double playerInventoryWidth = 165;
